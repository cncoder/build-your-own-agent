...
<svg viewBox="0 0 1600 900" xmlns="http://www.w3.org/2000/svg" font-family="'SF Mono', 'Menlo', monospace">
  ...
  <text x="800" y="80" fill="rgba(150,180,255,0.7)" font-size="12"
    ...
    从 50 行 Python 到能上互联网的通用 Agent · Ch 1 → Ch 24
  </text>
  ...
  <text x="200" y="120" fill="rgba(0,180,255,0.8)" font-size="10"
        text-anchor="middle" letter-spacing="1">Part 0 · 入门</text>
  ...
  <text x="710" y="120" fill="rgba(130,100,255,0.8)" font-size="10"
        text-anchor="middle" letter-spacing="1">Part 1-2 · 六大支柱 + 安全 + 常驻</text>
  ...
  <text x="1310" y="120" fill="rgba(0,220,120,0.8)" font-size="10"
        text-anchor="middle" letter-spacing="1">Part 3-4 · 扩展 + 专用化 + 大结局</text>
  ...
  <text x="120" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">API调用</text>
  <text x="120" y="514" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">10行Python</text>
  ...
  <text x="260" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">Lena诞生</text>
  <text x="260" y="514" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">50行·6模块</text>
  ...
  <text x="420" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">Tool系统</text>
  <text x="420" y="514" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">30+工具·并发</text>
  ...
  <text x="560" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">RAG检索</text>
  ...
  <text x="700" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">安全护栏</text>
  ...
  <text x="880" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">长任务Cron</text>
  <text x="880" y="514" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">断点续传</text>
  ...
  <text x="1080" y="500" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">专用化</text>
  <text x="1080" y="514" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">一行fork</text>

  <!-- v0.24 Ch24 —— 大结局节点，更大更亮 -->
  ...
  <text x="1380" y="347" fill="#00ff88" font-size="10"
        text-anchor="middle" letter-spacing="1">← 你在这里</text>

  <!-- 六大支柱标签 -->
  <text x="800" y="160" fill="rgba(255,200,100,0.8)" font-size="11" font-weight="bold"
        text-anchor="middle" letter-spacing="2">六大支柱覆盖</text>
  ...
  <text x="800" y="590" fill="rgba(255,255,255,0.4)" font-size="10" text-anchor="middle">
    24 章 · 6 大支柱 · 3000+ 行代码 · lena-v0.1 → lena-v0.24
  </text>
  ...
  <text x="800" y="650" fill="rgba(0,255,120,0.7)" font-size="11" font-weight="bold"
        text-anchor="middle" letter-spacing="2">lena-v0.24 Browser Agent 技术栈</text>

  <!-- 三层技术栈 -->
  <!-- LLM 决策层 -->
  <rect x="340" y="665" width="280" height="55" fill="rgba(180,100,255,0.1)"
        stroke="rgba(180,100,255,0.4)" stroke-width="1" rx="6"/>
  <text x="480" y="687" fill="#bb88ff" font-size="11" font-weight="bold" text-anchor="middle">LLM 决策层</text>
  <text x="480" y="703" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">Claude Sonnet · ChatBrowserUse</text>
  <text x="480" y="716" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">DOM 感知 → 动作决策</text>

  <!-- browser-use 框架层 -->
  <rect x="660" y="665" width="280" height="55" fill="rgba(0,200,100,0.1)"
        stroke="rgba(0,200,100,0.4)" stroke-width="1" rx="6"/>
  <text x="800" y="687" fill="#00cc66" font-size="11" font-weight="bold" text-anchor="middle">browser-use 框架层</text>
  <text x="800" y="703" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">92k stars · Playwright 底层</text>
  <text x="800" y="716" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">选择性 DOM 提取 · ActionHistory</text>

  <!-- CDP 控制层 -->
  <rect x="980" y="665" width="280" height="55" fill="rgba(0,150,255,0.1)"
        stroke="rgba(0,150,255,0.4)" stroke-width="1" rx="6"/>
  <text x="1120" y="687" fill="#00aaff" font-size="11" font-weight="bold" text-anchor="middle">Chrome CDP 控制层</text>
  <text x="1120" y="703" fill="rgba(255,255,255,0.6)" font-size="9" text-anchor="middle">WebSocket 9222 · custom-profile</text>
  <text x="1120" y="716" fill="rgba(255,255,255,0.4)" font-size="8" text-anchor="middle">截图 · Tab 管理 · DOM 注入</text>

  <!-- 三层 fallback -->
  <text x="800" y="752" fill="rgba(255,200,80,0.7)" font-size="10" text-anchor="middle">三层 Fallback：RSSHub（90%）→ opencli（70%）→ CDP（40%）= 整体 99%</text>

  <!-- 6 条血泪 -->
  <text x="800" y="778" fill="rgba(255,100,100,0.6)" font-size="9" text-anchor="middle">
    6 条血泪：①Origin头 ②代理变量 ③进程锁 ④Tab清理 ⑤截图空白 ⑥PUT方法
  </text>
