...
| 版本 | 日期 | 变更 |
|------|------|------|
| v2 | 2026-05-05 | 从零重写：引入骨架先行范式（Raschka DummyGPTModel 策略），6 模块逐一填充；新增 Beat 2 动机代码；将 MVA 6 模块表放入 Beat 3 理论铺垫而非一口气列出；强化 tool_result 回填顺序解释；新增 R9 自检表；修复 RULE-02 绝对路径违规（延伸阅读表）；修复 RULE-13 章末无钩子 |
| v1 | 2026-05-04 | 初版（已备份为 README-v1-discarded.md） |
